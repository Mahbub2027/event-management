...
const EventPhoto = () => {
    ...
    return (
        <div className="w-1/2 md:w-8/12 mx-auto my-20">
            <h2 className="text-3xl md:text-4xl font-bold text-center my-10">Events Gallery</h2>
            <div>
                
                    <div data-aos="zoom-out" className="flex justify-center md:justify-start">
                    ...
                    <div data-aos="zoom-out" className="flex justify-center md:justify-end">
